...
from drinking_gourd.app import create_app
from drinking_gourd.database import db
from drinking_gourd.settings import DevConfig, ProdConfig
from drinking_gourd.user.models import User

CONFIG = ProdConfig if os.environ.get('DRINKING_GOURD_ENV') == 'prod' else DevConfig
